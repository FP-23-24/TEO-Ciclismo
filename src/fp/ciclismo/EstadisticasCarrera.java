...
public interface EstadisticasCarrera {
	 ...
	 * @return Devuelve cierto si hay algún ganador de la nacionalidad dada como
	 *         parámetro.
	 */
	...
	/**
	 * @param nombreFichero
	 *    Nombre del fichero en el que se guarda la información.
 	 * @param nacionalidad Nacionalidad buscada.
 	 * Guarda en un fichero los ganadores de la carrera de la nacionalidad dada como
 	 * parámetro, con los años en los que ha ganado. Un ejemplo de línea del fichero 
 	 * generado es
	 ...
	 * @param anyoInicial Año inicial del intervalo. Se incluye en el resultado
	 ...
	 * con los n ganadores que hayan llevado más días el maillot en la carrera que ganaron.
	 */
	 ...
	 * representa al ganador de ese equipo que más días llevó el maillot amarillo en la carrera que ganó
	 */
	Map<String, Ganador> ganadorMasDiasMaillotPorEquipo();

	/**
	 * @return Una lista ordenada alfabéticamente con 
	 * las nacionalidades de los ganadores.
	 */
	List<String> getNacionalidadesGanadores();

	/**
	 * @param n Número de ciclistas a devolver.
	 * @return Devuelve los n ciclistas que han ganado más etapas
